    ...
    <section id="gallery">
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- <div class="row" id="g"> -->
                <div class="col-lg-3">
                    <img src="img/logo1.jpg" width="100%" height="200px">
                    <!-- <h3>Snacks</h3> -->
                    <hr>
                    <p>Are you looking for information about different types of foods, recipes, dietary advice, or
                        something else related to food? Please provide me with more details so I can help you
                ...
                <div class="col-lg-3">
                    <img src="img/logo3.jpeg" width="100%" height="200px">
                    <!-- <h3>Dinner</h3> -->
                    <hr>
                    <p>Are you looking for information about different types of foods, recipes, dietary advice, or
                        something else related to food? Please provide me with more details so I can help you
            ...
            <div class="row">
                ...
                <!-- <div class="row" id="g"> -->
                <div class="col-lg-3">
                    <img src="img/bb4.jpeg" width="100%" height="200px">
                    <!-- <h3>Snacks</h3> -->
                    <hr>
                    <p>Are you looking for information about different types of foods, recipes, dietary advice, or
                        something else related to food? Please provide me with more details so I can help you
                ...
                <div class="col-lg-3">
                    <img src="img/bb5.jpeg" width="100%" height="200px">
                    <!-- <h3>Dinner</h3> -->
                    <hr>
                    <p>Are you looking for information about different types of foods, recipes, dietary advice, or
                        something else related to food? Please provide me with more details so I can help you
